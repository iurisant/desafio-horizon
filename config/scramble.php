...
return [
    ...
    'info' => [
         ...
         */
        'description' => 'Documentação das rotas de backend para o cadastro de Fornecedores e Produtos do Desafio Horizon.',
    ],

    'ui' => [
        'title' => 'Desafio Horizon API',
    ],
